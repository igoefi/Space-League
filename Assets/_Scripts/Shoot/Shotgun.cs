...
public class Shotgun : Weapons
{
    protected override void Fire()
    {
        ...
        projectile_1.transform.rotation = Quaternion.Euler(projectile.transform.rotation.eulerAngles.x, projectile.transform.rotation.eulerAngles.y + 20, projectile.transform.rotation.eulerAngles.z);
        projectile_2.transform.rotation = Quaternion.Euler(projectile.transform.rotation.eulerAngles.x, projectile.transform.rotation.eulerAngles.y - 20, projectile.transform.rotation.eulerAngles.z);
